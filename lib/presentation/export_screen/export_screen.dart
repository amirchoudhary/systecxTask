...
class ExportScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<ExportBloc>(
        create: (context) =>
            ExportBloc(ExportState(exportModelObj: ExportModel()))
              ..add(ExportInitialEvent()),
        child: ExportScreen());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ExportBloc, ExportState>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
              body: SizedBox(
                  width: 360.h,
  ...
  /// Navigates to the exportTwoScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the [NavigatorService]
  /// to push the named route for the exportTwoScreen.
  onTapColumnpdfone(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.exportTwoScreen,
    );
  }
}
